...
import (
	config "app_server/proto/config"
...
type ConfigServiceClient interface {
	// POST /config.ConfigService/GetConfig
...
func NewConfigServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) ConfigServiceClient {
	...
	configServiceMethods := config.File_proto_config_config_proto.Services().ByName("ConfigService").Methods()
